...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5 bg-transparent backdrop-blur bg-black/70">
        ...
        <div
          className={`
            ...
            max-md:font-medium max-md:text-lg max-md:z-50
