...
const Dashboard = () => {
    ...
    const dashboardCards =[
        ...
        {title: "Total Renevue", value: currency + dashboardData.totalRevenue || "0",icon: CircleDollarSignIcon},
        ...
        <div className='relative flex flex-wrap gap-4 mt-6'>
            ...
            <div className='flex flex-wrap gap-4 w-full'>
                {dashboardCards.map((card,index)=>(
                    ...
                    bg-primary/10 border border-primary/20 rouded-md max-w-50 w-full'>
                        <div>
