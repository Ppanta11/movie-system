...
const HeroSection = () => {
  ...
  return (
    ...
    px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        <img src={assets.marvelLogo} alt='' className='max-h-11 lh:h-11 mt-20'/>
        ...
        <p className='max-w-md text-grey-300' > Marvel's Guardians of the Galaxy is a 2021 action-adventure game developed by Eidos-Montréal and originally
            published by Square Enix.</p>
